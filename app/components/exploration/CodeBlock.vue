...
<template>
  <details v-if="collapsible" class="group mt-1" :open="open">
    ...
    <div class="agent-inset-surface mt-2 overflow-hidden">
      <div class="flex min-h-8 items-center justify-between border-b border-[#ddd] px-2.5 text-[10px] text-[#666]">
      ...
      <pre class="max-h-44 overflow-auto px-3 py-2.5 font-mono text-[11px] leading-5"><code class="hljs" :class="languageClass" v-html="highlightedCode" /></pre>
    </div>
  </details>
